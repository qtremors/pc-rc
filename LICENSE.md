...
- Include a link to the original repository: `https://github.com/qtremors/pc-rc`
...
```
Based on PC Remote Control by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/pc-rc
```
